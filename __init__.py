...
class Profiles(UserMixin, db.Model):
    ...
    slimlink = db.Column(db.Integer, nullable=False)
...
@app.route("/unique_visit", methods = ["POST"])
def unique_visit():
    if request.method == "POST":
        ...
        view = Website_visitors(ip_address = ip,country = info["country_name"],state = info["region_name"],date = datetime.datetime.now())
        db.session.add(view)
        db.session.commit()
...
@login_required
def addclub():
    permission_email = ["subhadra.bansal2020@vitbhopal.ac.in","dhananjay.arne2020@vitbhopal.ac.in"]
...
def save_profile():
    if request.method == "POST":
        ...
        slimlink  = request.form.get("slimlink")
        bio  = request.form.get("bio")
        user = Profiles.query.filter_by(email=current_user.email).first()
        user.name = name
        user.branch = branch
        user.slimlink   = slimlink
        user.bio = bio
        db.session.commit()
...
<meta name="google-signin-client_id" content="1011033670886-tnm4j0l54lcaoea6jgi11cg17dvnqvb0.apps.googleusercontent.com">
            ...
            <div class="page-content bg-white">
                ...
                <div class="content-block">
                    ...
                    {% endif %}
                        ...
                        <a href="#" onclick="signOut();" style="float: right; bottom: 0;  "  class="btn btn-danger">Logout</a>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                                    <div class="profile-bx text-center">
                                        ...
                                        {% if user.slimlink == "" %}
                                    <a href="#" onclick="alert('Slimlink Is Not Added Yet')"> <u>My Slimlink</u></a>
                                    {% else %}
                                    <a href="https://slimlink.in/@{{user.slimlink}}" target="_blank"> <u>My Slimlink</u></a>
                                    {% endif %}
                                            ...
                                            <div class="tab-pane" id="edit-profile">
                                                ...
                                                <form class="edit-profile" action="/save_profile" method="post">
                                                    <div class="">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Slimlink Username</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                            
                                                                    {% if owner %}
                                                                    <input class="form-control" type="text" name="slimlink" value="{{user.slimlink}}"
                                                                    >
                                                                    <small><a href="https://slimlink.in/"><u>What Is Slimlink?</u></a></small>
                                                            
                                                                {% else %}
                                                                <input class="form-control" type="text"  name="slimlink"  readonly value="{{user.slimlink}}"
                                                                >
                                                                {% endif %}
                                                            </div>
                                                        </div>
